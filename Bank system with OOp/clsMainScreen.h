...
private:
    enum enMainMenueOptions {
        ...
        eManageUsers = 7,eLoginHistory = 8 ,eCurrencyExhange = 9 , eExit = 10
    };
    ...
    static void _ShowCurrencyExhangeMenu()
    {
        clsCurrencyExhangeScreen::CurrencyMenue();
       // cout << "You will be here soon" << endl;
